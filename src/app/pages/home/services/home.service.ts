...
export class HomeService 
{
	...
	{ 
		...
		{ 
			...
			requestModel.AddGetRequest('https://www.googleapis.com/youtube/v3/search?key=AIzaSyBKYjsroCoNKERWIc5vXRgfFK1Ds6Dkfik&part=snippet&channelId=UCdNXQTnqhsnOa16lhbuvJ5w&order=date&maxResults=8');
