...
export class HomeService 
{
	...
	{ 
		...
		{ 
			...
			requestModel.AddGetRequest('https://www.googleapis.com/youtube/v3/playlists?part=unlisted&channelId=UCdNXQTnqhsnOa16lhbuvJ5w&order=date&maxResults=8&key=AIzaSyBKYjsroCoNKERWIc5vXRgfFK1Ds6Dkfik');
